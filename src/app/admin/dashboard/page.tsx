...
export default function AdminDashboardPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="relative overflow-hidden bg-white rounded-[2rem] shadow-xl border p-8"
      >
        <h2 className="text-3xl font-black text-slate-900">
          System Overview <span className="text-yellow-500">Admin 👋</span>
        </h2>
        <p className="text-slate-500 mt-2">
          Manage drones, orders, and users from one place.
        </p>
      </motion.div>
